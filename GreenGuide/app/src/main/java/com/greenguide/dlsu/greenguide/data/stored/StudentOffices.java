...
public class StudentOffices {
    ...
    private void insertPrograms(){
        ...
        programs.add(new NameTag("Pahiram Payong and Pahiram Libro", "A program that allows students to borrow an umbrella, free of charge from North Gate, Agno Gate, and Br. Andrew Gonzales, FSC Hall in the Taft Campus and East Wing Canopy in the Science and Technology Complex, and borrow textbooks for one whole term, free of charge. Book reservation is done via www.dlsu-usg.com during specified dates announced by the USG."));
