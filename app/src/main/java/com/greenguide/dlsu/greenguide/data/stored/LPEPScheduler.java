...
public class LPEPScheduler {
    ...
    private void addScheduleA(){
        ...
        scheduleA.add( new Schedule("- Introduction to the Lasallian Formation and Action Framework\n\n" +
        ...
        scheduleA.add( new Schedule("- CSO Video\n\n" +
                "- Q&A", "11:45 - 11:50 AM", "Day 2"));
        scheduleA.add( new Schedule("Movement to Eating Area", "11:50 - 12:00 PM", "Day 2"));
